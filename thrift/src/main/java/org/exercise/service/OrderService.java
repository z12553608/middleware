...
public class OrderService {
  ...
  public interface Iface {
    ...
    public org.exercise.order.OrderResp createOrder(org.exercise.order.OrderReq request) throws org.apache.thrift.TException;

  }

  public interface AsyncIface {

    public void createOrder(org.exercise.order.OrderReq request, org.apache.thrift.async.AsyncMethodCallback<org.exercise.order.OrderResp> resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public org.exercise.order.OrderResp createOrder(org.exercise.order.OrderReq request) throws org.apache.thrift.TException
    {
      send_createOrder(request);
      return recv_createOrder();
    }

    public void send_createOrder(org.exercise.order.OrderReq request) throws org.apache.thrift.TException
    {
    ...
    public org.exercise.order.OrderResp recv_createOrder() throws org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public void createOrder(org.exercise.order.OrderReq request, org.apache.thrift.async.AsyncMethodCallback<org.exercise.order.OrderResp> resultHandler) throws org.apache.thrift.TException {
      checkReady();
      createOrder_call method_call = new createOrder_call(request, resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }

    public static class createOrder_call extends org.apache.thrift.async.TAsyncMethodCall<org.exercise.order.OrderResp> {
      private org.exercise.order.OrderReq request;
      public createOrder_call(org.exercise.order.OrderReq request, org.apache.thrift.async.AsyncMethodCallback<org.exercise.order.OrderResp> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
      ...
      public org.exercise.order.OrderResp getResult() throws org.apache.thrift.TException {
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
    ...
    public static class createOrder<I extends Iface> extends org.apache.thrift.ProcessFunction<I, createOrder_args> {
      ...
      public createOrder_result getResult(I iface, createOrder_args args) throws org.apache.thrift.TException {
        createOrder_result result = new createOrder_result();
        result.success = iface.createOrder(args.request);
        return result;
      }
    }
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class createOrder<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, createOrder_args, org.exercise.order.OrderResp> {
      public createOrder() {
        super("createOrder");
      }
      ...
      public org.apache.thrift.async.AsyncMethodCallback<org.exercise.order.OrderResp> getResultHandler(final org.apache.thrift.server.AbstractNonblockingServer.AsyncFrameBuffer fb, final int seqid) {
        final org.apache.thrift.AsyncProcessFunction fcall = this;
        return new org.apache.thrift.async.AsyncMethodCallback<org.exercise.order.OrderResp>() { 
          public void onComplete(org.exercise.order.OrderResp o) {
            createOrder_result result = new createOrder_result();
            result.success = o;
            try {
      ...
      public void start(I iface, createOrder_args args, org.apache.thrift.async.AsyncMethodCallback<org.exercise.order.OrderResp> resultHandler) throws org.apache.thrift.TException {
        iface.createOrder(args.request,resultHandler);
      }
    }
  ...
  public static class createOrder_args implements org.apache.thrift.TBase<createOrder_args, createOrder_args._Fields>, java.io.Serializable, Cloneable, Comparable<createOrder_args>   {
    ...
    public @org.apache.thrift.annotation.Nullable org.exercise.order.OrderReq request; // required
    ...
    static {
      ...
      tmpMap.put(_Fields.REQUEST, new org.apache.thrift.meta_data.FieldMetaData("request", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, org.exercise.order.OrderReq.class)));
    ...
    public createOrder_args(
      org.exercise.order.OrderReq request)
    {
      this();
      this.request = request;
    }
    ...
    public createOrder_args(createOrder_args other) {
      if (other.isSetRequest()) {
        this.request = new org.exercise.order.OrderReq(other.request);
      }
    }
    ...
    @org.apache.thrift.annotation.Nullable
    public org.exercise.order.OrderReq getRequest() {
      return this.request;
    }

    public createOrder_args setRequest(@org.apache.thrift.annotation.Nullable org.exercise.order.OrderReq request) {
      this.request = request;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
      ...
      case REQUEST:
        if (value == null) {
          ...
          setRequest((org.exercise.order.OrderReq)value);
        }
        break;
          ...
          switch (schemeField.id) {
            case -1: // REQUEST
              if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
                struct.request = new org.exercise.order.OrderReq();
  ...
  public static class createOrder_result implements org.apache.thrift.TBase<createOrder_result, createOrder_result._Fields>, java.io.Serializable, Cloneable, Comparable<createOrder_result>   {
    ...
    public @org.apache.thrift.annotation.Nullable org.exercise.order.OrderResp success; // required
    ...
    static {
      ...
      tmpMap.put(_Fields.SUCCESS, new org.apache.thrift.meta_data.FieldMetaData("success", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, org.exercise.order.OrderResp.class)));
      metaDataMap = java.util.Collections.unmodifiableMap(tmpMap);
    ...
    public createOrder_result(
      org.exercise.order.OrderResp success)
    {
      this();
    ...
    public createOrder_result(createOrder_result other) {
      if (other.isSetSuccess()) {
        this.success = new org.exercise.order.OrderResp(other.success);
      }
    }
    ...
    @org.apache.thrift.annotation.Nullable
    public org.exercise.order.OrderResp getSuccess() {
      return this.success;
    }

    public createOrder_result setSuccess(@org.apache.thrift.annotation.Nullable org.exercise.order.OrderResp success) {
      this.success = success;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
      ...
      case SUCCESS:
        if (value == null) {
          ...
          setSuccess((org.exercise.order.OrderResp)value);
        }
        break;
      ...
      public void read(org.apache.thrift.protocol.TProtocol iprot, createOrder_result struct) throws org.apache.thrift.TException {
        ...
        while (true)
        {
          ...
          switch (schemeField.id) {
            case 0: // SUCCESS
              if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
                struct.success = new org.exercise.order.OrderResp();
